...
void redraw() {
    ...
    std::cout << "Sigma 1: " << width_1 << " +- " << width_1_error << "\n";
    std::cout << "Sigma 2: " << width_2 << " +- " << width_2_error << "\n";
    std::cout << "Sigma 3: " << width_3 << " +- " << width_3_error << "\n";
    std::cout << "Sigma 4: " << width_4 << " +- " << width_4_error << "\n";
    ...
    g_sigma->SetTitle("Sigma vs Energy;Energy (MeV);Sigma (MeV)");
