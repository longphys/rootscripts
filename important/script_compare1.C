...
double minTestCo60 = 0.8; //MeV
double maxTestCo60 = 1.2;
...
double ScaleCs137[3] = {7.9, 8.5, 10.7};
double ScaleNa22[3] = {3.0, 3.6, 3.4};
double ScaleCo60[3] = {3.8, 4.5, 5.0};
...
double fitLinear(int channelCs137, int channelNa22, int channelCo60, TCanvas* canvasFit, int i){
  ...
  hCali->SetBinContent(channelCo60 - xminExp, E3);
...
double fitRes(double Sig1, double Sig2, double Sig3, TH1D* hCs137, TH1D* hNa22, TH1D* hCo60,
 double xmin, double xmax, TCanvas* canvasFit, int i){
  TH1D* hRes = new TH1D("hRes", "Resolution fit", binExp, xmin, xmax);
  hRes->GetXaxis()->SetTitle("Energy (MeV)");
  ...
  hRes->SetBinContent(hCo60->FindBin(E3), Sig3/100.);
...
void script_compare1()
{
  ...
  TH1D* hExpCo60Filtered = fft(hExpCo60, 0.1, inithreshCo60, "hExpCo60Filtered", "Co60 Spectrum Filtered", binExp, xminExp, xmaxExp);
  hExpCo60Filtered->GetXaxis()->SetTitle("Channel");
  hExpCo60Filtered->GetYaxis()->SetTitle("Count");
  ...
  cShow2->cd(6);
  hExpCo60Diff->Draw();
  hExpCo60Diff->GetXaxis()->SetRangeUser(minRangeCo60, maxRangeCo60);
  int Ch3 = hExpCo60Diff->GetMinimumBin() + xminExp;
  // std::cout << "Ch3 = " << Ch3 << "\n";
  ...
  double chi2_Cs137, chi2_Na22, chi2_Co60;
  TGraph* grChi2_Cs137 = new TGraph();
  TGraph* grChi2_Na22 = new TGraph();
  TGraph* grChi2_Co60 = new TGraph();
  ...
  while (deltaChi2>thresh){
    ...
    double a = fitLinear(Ch1, Ch2, Ch3, cFit, 0);
    double b = fitLinear(Ch1, Ch2, Ch3, cFit, 1);

    double aUpCh1 = fitLinear(Ch1+Ch1step, Ch2, Ch3, cFit, 0);
    double bUpCh1 = fitLinear(Ch1+Ch1step, Ch2, Ch3, cFit, 1);

    double aUpCh2 = fitLinear(Ch1, Ch2+Ch2step, Ch3, cFit, 0);
    double bUpCh2 = fitLinear(Ch1, Ch2+Ch2step, Ch3, cFit, 1);

    double aUpCh3 = fitLinear(Ch1, Ch2, Ch3+Ch3step, cFit, 0);
    double bUpCh3 = fitLinear(Ch1, Ch2, Ch3+Ch3step, cFit, 1);
    ...
    double xminCalUpCh3 = xminExp*aUpCh3+bUpCh3;
    double xmaxCalUpCh3 = xmaxExp*aUpCh3+bUpCh3;
    ...
    TH1D* hsimCs137resUpCh3 = new TH1D("hsimCs137resUpCh3", "Cs137 Simulation with resolution", binExp, xminCalUpCh3, xmaxCalUpCh3);
    TH1D* hcalCs137UpCh3 = new TH1D("hcalCs137UpCh3", "Cs137 Experiment Calibrated", binExp, xminCalUpCh3, xmaxCalUpCh3);
    ...
    TH1D* hsimCs137resUpSig3 = new TH1D("hsimCs137resUpSig3", "Cs137 Simulation with resolution", binExp, xminCal, xmaxCal);
    ...
    TH1D* hsimNa22resUpCh3 = new TH1D("hsimNa22resUpCh3", "Na22 Simulation with resolution", binExp, xminCalUpCh3, xmaxCalUpCh3);
    TH1D* hcalNa22UpCh3 = new TH1D("hcalNa22UpCh3", "Na22 Experiment Calibrated", binExp, xminCalUpCh3, xmaxCalUpCh3);
    ...
    TH1D* hsimNa22resUpSig3 = new TH1D("hsimNa22resUpSig3", "Na22 Simulation with resolution", binExp, xminCal, xmaxCal);
    ...
    TH1D* hsimCo60resUpCh1 = new TH1D("hsimCo60resUpCh1", "Co60 Simulation with resolution", binExp, xminCalUpCh1, xmaxCalUpCh1);
    TH1D* hcalCo60UpCh1 = new TH1D("hcalCo60UpCh1", "Co60 Experiment Calibrated", binExp, xminCalUpCh1, xmaxCalUpCh1);

    TH1D* hsimCo60resUpCh2 = new TH1D("hsimCo60resUpCh2", "Co60 Simulation with resolution", binExp, xminCalUpCh2, xmaxCalUpCh2);
    TH1D* hcalCo60UpCh2 = new TH1D("hcalCo60UpCh2", "Co60 Experiment Calibrated", binExp, xminCalUpCh2, xmaxCalUpCh2);

    TH1D* hsimCo60resUpCh3 = new TH1D("hsimCo60resUpCh3", "Co60 Simulation with resolution", binExp, xminCalUpCh3, xmaxCalUpCh3);
    TH1D* hcalCo60UpCh3 = new TH1D("hcalCo60UpCh3", "Co60 Experiment Calibrated", binExp, xminCalUpCh3, xmaxCalUpCh3);

    TH1D* hsimCo60resUpSig1 = new TH1D("hsimCo60resUpSig1", "Co60 Simulation with resolution", binExp, xminCal, xmaxCal);

    TH1D* hsimCo60resUpSig2 = new TH1D("hsimCo60resUpSig2", "Co60 Simulation with resolution", binExp, xminCal, xmaxCal);

    TH1D* hsimCo60resUpSig3 = new TH1D("hsimCo60resUpSig3", "Co60 Simulation with resolution", binExp, xminCal, xmaxCal);
    ...
    for(int i = 0; i < entriesExpCs137; i++){
      ...
      hcalCs137UpCh3->Fill(aUpCh3*(chX[channel]+0.5) + bUpCh3);
    }
    ...
    TH1D* hcalCs137UpCh3Filtered = fft(hcalCs137UpCh3, 0.1, threshExp, "hcalCs137UpCh3Filtered", "hcalCs137UpCh3Filtered", binExp, xminCalUpCh3, xmaxCalUpCh3);
    ...
    for(int i = 0; i < entriesExpNa22; i++){
      ...
      hcalNa22UpCh3->Fill(aUpCh3*(chY[channel]+0.5) + bUpCh3);
    }
    ...
    TH1D* hcalNa22UpCh3Filtered = fft(hcalNa22UpCh3, 0.1, threshExp, "hcalNa22UpCh3Filtered", "hcalNa22UpCh3Filtered", binExp, xminCalUpCh3, xmaxCalUpCh3);

    //! Fill experiment histograms (Co60)
    for(int i = 0; i < entriesExpCo60; i++){
      texpCo60->GetEntry(i);
      hcalCo60->Fill(a*(chZ[channel]+0.5) + b);
      hcalCo60UpCh1->Fill(aUpCh1*(chZ[channel]+0.5) + bUpCh1);
      hcalCo60UpCh2->Fill(aUpCh2*(chZ[channel]+0.5) + bUpCh2);
      hcalCo60UpCh3->Fill(aUpCh3*(chZ[channel]+0.5) + bUpCh3);
    }
    TH1D* hcalCo60Filtered = fft(hcalCo60, 0.1, threshExp, "hcalCo60Filtered", "hcalCo60Filtered", binExp, xminCal, xmaxCal);
    TH1D* hcalCo60UpCh1Filtered = fft(hcalCo60UpCh1, 0.1, threshExp, "hcalCo60UpCh1Filtered", "hcalCo60UpCh1Filtered", binExp, xminCalUpCh1, xmaxCalUpCh1);
    TH1D* hcalCo60UpCh2Filtered = fft(hcalCo60UpCh2, 0.1, threshExp, "hcalCo60UpCh2Filtered", "hcalCo60UpCh2Filtered", binExp, xminCalUpCh2, xmaxCalUpCh2);
    TH1D* hcalCo60UpCh3Filtered = fft(hcalCo60UpCh3, 0.1, threshExp, "hcalCo60UpCh3Filtered", "hcalCo60UpCh3Filtered", binExp, xminCalUpCh3, xmaxCalUpCh3);

    //! Prepare Energy Resolution coefficients
    double coA = fitRes(dSig1, dSig2, dSig3, hcalCs137Filtered, hcalNa22Filtered, hcalCo60Filtered, xminCal, xmaxCal, cFit, 0);
    double coB = fitRes(dSig1, dSig2, dSig3, hcalCs137Filtered, hcalNa22Filtered, hcalCo60Filtered, xminCal, xmaxCal, cFit, 1);
    double coC = fitRes(dSig1, dSig2, dSig3, hcalCs137Filtered, hcalNa22Filtered, hcalCo60Filtered, xminCal, xmaxCal, cFit, 2);

    double coAUpSig1 = fitRes(dSig1+dSig1step, dSig2, dSig3, hcalCs137Filtered, hcalNa22Filtered, hcalCo60Filtered, xminCal, xmaxCal, cFit, 0);
    double coBUpSig1 = fitRes(dSig1+dSig1step, dSig2, dSig3, hcalCs137Filtered, hcalNa22Filtered, hcalCo60Filtered, xminCal, xmaxCal, cFit, 1);
    double coCUpSig1 = fitRes(dSig1+dSig1step, dSig2, dSig3, hcalCs137Filtered, hcalNa22Filtered, hcalCo60Filtered, xminCal, xmaxCal, cFit, 2);

    double coAUpSig2 = fitRes(dSig1, dSig2+dSig2step, dSig3, hcalCs137Filtered, hcalNa22Filtered, hcalCo60Filtered, xminCal, xmaxCal, cFit, 0);
    double coBUpSig2 = fitRes(dSig1, dSig2+dSig2step, dSig3, hcalCs137Filtered, hcalNa22Filtered, hcalCo60Filtered, xminCal, xmaxCal, cFit, 1);
    double coCUpSig2 = fitRes(dSig1, dSig2+dSig2step, dSig3, hcalCs137Filtered, hcalNa22Filtered, hcalCo60Filtered, xminCal, xmaxCal, cFit, 2);

    double coAUpSig3 = fitRes(dSig1, dSig2, dSig3+dSig3step, hcalCs137Filtered, hcalNa22Filtered, hcalCo60Filtered, xminCal, xmaxCal, cFit, 0);
    double coBUpSig3 = fitRes(dSig1, dSig2, dSig3+dSig3step, hcalCs137Filtered, hcalNa22Filtered, hcalCo60Filtered, xminCal, xmaxCal, cFit, 1);
    double coCUpSig3 = fitRes(dSig1, dSig2, dSig3+dSig3step, hcalCs137Filtered, hcalNa22Filtered, hcalCo60Filtered, xminCal, xmaxCal, cFit, 2);
    ...
    TH1D* hsimCs137resUpCh2Filtered = fft(hsimCs137resUpCh2, 0.1, threshSim, "hsimCs137resUpCh2Filtered", "hsimCs137resUpCh2Filtered", binExp, xminCalUpCh2, xmaxCalUpCh2);
    TH1D* hsimCs137resUpCh3Filtered = fft(hsimCs137resUpCh3, 0.1, threshSim, "hsimCs137resUpCh3Filtered", "hsimCs137resUpCh3Filtered", binExp, xminCalUpCh3, xmaxCalUpCh3);
    ...
    {
      tsimCs137->GetEntry(i);
      double sigma = x_sim*sqrt( pow(coAUpSig3,2) + pow(coBUpSig3/sqrt(x_sim),2) + pow((coCUpSig3)/x_sim,2) );
      hsimCs137resUpSig3->Fill(ranGen->Gaus(x_sim,sigma));
    }
    TH1D* hsimCs137resUpSig3Filtered = fft(hsimCs137resUpSig3, 0.1, threshSim, "hsimCs137resUpSig3Filtered", "hsimCs137resUpSig3Filtered", binExp, xminCal, xmaxCal);
    ...
    TH1D* hsimNa22resUpCh3Filtered = fft(hsimNa22resUpCh3, 0.1, threshSim, "hsimNa22resUpCh3Filtered", "hsimNa22resUpCh3Filtered", binExp, xminCalUpCh3, xmaxCalUpCh3);
    ...
    {
      tsimNa22->GetEntry(i);
      double sigma = y_sim*sqrt( pow(coAUpSig3,2) + pow(coBUpSig3/sqrt(y_sim),2) + pow((coCUpSig3)/y_sim,2) );
      hsimNa22resUpSig3->Fill(ranGen->Gaus(y_sim,sigma));
    }
    TH1D* hsimNa22resUpSig3Filtered = fft(hsimNa22resUpSig3, 0.1, threshSim, "hsimNa22resUpSig3Filtered", "hsimNa22resUpSig3Filtered", binExp, xminCal, xmaxCal);
    ...
    for (int i = 0; i < entriesSimCo60; i++)
    {
      ...
      hsimCo60resUpCh1->Fill(energy);
      hsimCo60resUpCh2->Fill(energy);
      hsimCo60resUpCh3->Fill(energy);
    }
    TH1D* hsimCo60resFiltered = fft(hsimCo60res, 0.1, threshSim-30., "hsimCo60resFiltered", "hsimCo60resFiltered", binExp, xminCal, xmaxCal);
    TH1D* hsimCo60resUpCh1Filtered = fft(hsimCo60resUpCh1, 0.1, threshSim-30., "hsimCo60resUpCh1Filtered", "hsimCo60resUpCh1Filtered", binExp, xminCalUpCh1, xmaxCalUpCh1);
    TH1D* hsimCo60resUpCh2Filtered = fft(hsimCo60resUpCh2, 0.1, threshSim-30., "hsimCo60resUpCh2Filtered", "hsimCo60resUpCh2Filtered", binExp, xminCalUpCh2, xmaxCalUpCh2);
    TH1D* hsimCo60resUpCh3Filtered = fft(hsimCo60resUpCh3, 0.1, threshSim-30., "hsimCo60resUpCh3Filtered", "hsimCo60resUpCh3Filtered", binExp, xminCalUpCh3, xmaxCalUpCh3);

    for (int i = 0; i < entriesSimCo60; i++)
    {
      tsimCo60->GetEntry(i);
      double sigma = z_sim*sqrt( pow(coAUpSig1,2) + pow(coBUpSig1/sqrt(z_sim),2) + pow(coCUpSig1/z_sim,2) );
      hsimCo60resUpSig1->Fill(ranGen->Gaus(z_sim,sigma));
    }
    TH1D* hsimCo60resUpSig1Filtered = fft(hsimCo60resUpSig1, 0.1, threshSim-30., "hsimCo60resUpSig1Filtered", "hsimCo60resUpSig1Filtered", binExp, xminCal, xmaxCal);
  
    for (int i = 0; i < entriesSimCo60; i++)
    {
      tsimCo60->GetEntry(i);
      double sigma = z_sim*sqrt( pow(coAUpSig2,2) + pow(coBUpSig2/sqrt(z_sim),2) + pow((coCUpSig2)/z_sim,2) );
      hsimCo60resUpSig2->Fill(ranGen->Gaus(z_sim,sigma));
    }
    TH1D* hsimCo60resUpSig2Filtered = fft(hsimCo60resUpSig2, 0.1, threshSim-30., "hsimCo60resUpSig2Filtered", "hsimCo60resUpSig2Filtered", binExp, xminCal, xmaxCal);

    for (int i = 0; i < entriesSimCo60; i++)
    {
      tsimCo60->GetEntry(i);
      double sigma = z_sim*sqrt( pow(coAUpSig3,2) + pow(coBUpSig3/sqrt(z_sim),2) + pow((coCUpSig3)/z_sim,2) );
      hsimCo60resUpSig3->Fill(ranGen->Gaus(z_sim,sigma));
    }
    TH1D* hsimCo60resUpSig3Filtered = fft(hsimCo60resUpSig3, 0.1, threshSim-30., "hsimCo60resUpSig3Filtered", "hsimCo60resUpSig3Filtered", binExp, xminCal, xmaxCal);

    hcalCo60Filtered->GetXaxis()->SetRangeUser(minTestCo60, maxTestCo60);
    hsimCo60resFiltered->GetXaxis()->SetRangeUser(minTestCo60, maxTestCo60);
    ...
    + abs(chi2(hcalCo60Filtered, hsimCo60resFiltered) -chi2_Co60);}
    ...
    chi2_Co60 = chi2(hcalCo60Filtered, hsimCo60resFiltered);
    std::cout << "~~~~~~~~~~~CHECK~~~~~~~~~~~~\n";
    ...
    grChi2_Co60->SetTitle("|r-Chi2 - 1| by iteration (Co60)");
    grChi2_Co60->GetXaxis()->SetTitle("Iteration");
    grChi2_Co60->GetYaxis()->SetTitle("|r-Chi2 - 1|");
    grChi2_Co60->AddPoint(count, chi2_Co60);
    ...
    hcalCs137UpCh3Filtered->GetXaxis()->SetRangeUser(minTestCs137, maxTestCs137);
    hsimCs137resUpCh3Filtered->GetXaxis()->SetRangeUser(minTestCs137, maxTestCs137);
    double chi2_Cs137_UpCh3 = chi2(hcalCs137UpCh3Filtered, hsimCs137resUpCh3Filtered);
    ...
    hsimCs137resUpSig3Filtered->GetXaxis()->SetRangeUser(minTestCs137, maxTestCs137);
    double chi2_Cs137_UpSig3 = chi2(hcalCs137Filtered, hsimCs137resUpSig3Filtered);
    ...
    hcalNa22UpCh3Filtered->GetXaxis()->SetRangeUser(minTestNa22, maxTestNa22);
    hsimNa22resUpCh3Filtered->GetXaxis()->SetRangeUser(minTestNa22, maxTestNa22);
    double chi2_Na22_UpCh3 = chi2(hcalNa22UpCh3Filtered, hsimNa22resUpCh3Filtered);
    ...
    hsimNa22resUpSig3Filtered->GetXaxis()->SetRangeUser(minTestNa22, maxTestNa22);
    double chi2_Na22_UpSig3 = chi2(hcalNa22Filtered, hsimNa22resUpSig3Filtered);

    //! Gradient(Co60)
    hcalCo60UpCh1Filtered->GetXaxis()->SetRangeUser(minTestCo60, maxTestCo60);
    hsimCo60resUpCh1Filtered->GetXaxis()->SetRangeUser(minTestCo60, maxTestCo60);
    double chi2_Co60_UpCh1 = chi2(hcalCo60UpCh1Filtered, hsimCo60resUpCh1Filtered);

    hcalCo60UpCh2Filtered->GetXaxis()->SetRangeUser(minTestCo60, maxTestCo60);
    hsimCo60resUpCh2Filtered->GetXaxis()->SetRangeUser(minTestCo60, maxTestCo60);
    double chi2_Co60_UpCh2 = chi2(hcalCo60UpCh2Filtered, hsimCo60resUpCh2Filtered);

    hcalCo60UpCh3Filtered->GetXaxis()->SetRangeUser(minTestCo60, maxTestCo60);
    hsimCo60resUpCh3Filtered->GetXaxis()->SetRangeUser(minTestCo60, maxTestCo60);
    double chi2_Co60_UpCh3 = chi2(hcalCo60UpCh3Filtered, hsimCo60resUpCh3Filtered);

    hsimCo60resUpSig1Filtered->GetXaxis()->SetRangeUser(minTestCo60, maxTestCo60);
    double chi2_Co60_UpSig1 = chi2(hcalCo60Filtered, hsimCo60resUpSig1Filtered);
    
    hsimCo60resUpSig2Filtered->GetXaxis()->SetRangeUser(minTestCo60, maxTestCo60);
    double chi2_Co60_UpSig2 = chi2(hcalCo60Filtered, hsimCo60resUpSig2Filtered);

    hsimCo60resUpSig3Filtered->GetXaxis()->SetRangeUser(minTestCo60, maxTestCo60);
    double chi2_Co60_UpSig3 = chi2(hcalCo60Filtered, hsimCo60resUpSig3Filtered);

    //! Derivative (Cs137&Na22&Co60)
    double devChi2UpCh1 = ((chi2_Cs137_UpCh1+chi2_Na22_UpCh1+chi2_Co60_UpCh1)-(chi2_Cs137+chi2_Na22+chi2_Co60))/Ch1step;
    double devChi2UpCh2 = ((chi2_Cs137_UpCh2+chi2_Na22_UpCh2+chi2_Co60_UpCh2)-(chi2_Cs137+chi2_Na22+chi2_Co60))/Ch2step;
    double devChi2UpCh3 = ((chi2_Cs137_UpCh3+chi2_Na22_UpCh3+chi2_Co60_UpCh3)-(chi2_Cs137+chi2_Na22+chi2_Co60))/Ch3step;
    double devChi2UpSig1 = ((chi2_Cs137_UpSig1+chi2_Na22_UpSig1+chi2_Co60_UpSig1)-(chi2_Cs137+chi2_Na22+chi2_Co60))/dSig1step;
    double devChi2UpSig2 = ((chi2_Cs137_UpSig2+chi2_Na22_UpSig2+chi2_Co60_UpSig2)-(chi2_Cs137+chi2_Na22+chi2_Co60))/dSig2step;
    double devChi2UpSig3 = ((chi2_Cs137_UpSig3+chi2_Na22_UpSig3+chi2_Co60_UpSig3)-(chi2_Cs137+chi2_Na22+chi2_Co60))/dSig3step;

    std::cout << "devChi2UpCh1 = " << devChi2UpCh1 << "; devChi2UpCh2 = " << devChi2UpCh2 << "; devChi2UpCh3 = " << devChi2UpCh3
    << "\ndevChi2UpSig1 = " << devChi2UpSig1 << "; devChi2UpSig2 = " << devChi2UpSig2 << "; devChi2UpSig3 = " << devChi2UpSig3 << "\n";

    Ch1 = Ch1 - tuningRateCh1*devChi2UpCh1;
    Ch2 = Ch2 - tuningRateCh2*devChi2UpCh2;
    Ch3 = Ch3 - tuningRateCh3*devChi2UpCh3;

    dSig1 = dSig1 - tuningRateSig1*devChi2UpSig1;
    dSig2 = dSig2 - tuningRateSig2*devChi2UpSig2;
    dSig3 = dSig3 - tuningRateSig3*devChi2UpSig3;
    ...
    hsimCo60resFiltered->Scale(ScaleCo60[channel], "noSW2");
    ...
    cShow1->cd(3);    
    hcalCs137UpCh3Filtered->SetLineColor(kRed);
    hcalCs137UpCh3Filtered->Draw();
    hsimCs137resUpCh3Filtered->Scale(ScaleCs137[channel], "noSW2");
    hsimCs137resUpCh3Filtered->Draw("same");
    ...
    cShow1->cd(6);
    hcalCs137Filtered->Draw();
    hsimCs137resUpSig3Filtered->Scale(ScaleCs137[channel], "noSW2");
    hsimCs137resUpSig3Filtered->Draw("same");
    ...
    cShow1->cd(9);    
    hcalNa22UpCh3Filtered->SetLineColor(kRed);
    hcalNa22UpCh3Filtered->Draw();
    hsimNa22resUpCh3Filtered->Scale(ScaleNa22[channel], "noSW2");
    hsimNa22resUpCh3Filtered->Draw("same");
    ...
    cShow1->cd(12);
    hcalNa22Filtered->Draw();
    hsimNa22resUpSig3Filtered->Scale(ScaleNa22[channel], "noSW2");
    hsimNa22resUpSig3Filtered->Draw("same");
    cShow1->cd(12)->Modified();
    cShow1->cd(12)->Update();

    cShow1->cd(13);    
    hcalCo60UpCh1Filtered->SetLineColor(kRed);
    hcalCo60UpCh1Filtered->Draw();
    hsimCo60resUpCh1Filtered->Scale(ScaleCo60[channel], "noSW2");
    hsimCo60resUpCh1Filtered->Draw("same");
    cShow1->cd(13)->Modified();
    cShow1->cd(13)->Update();

    cShow1->cd(14);    
    hcalCo60UpCh2Filtered->SetLineColor(kRed);
    hcalCo60UpCh2Filtered->Draw();
    hsimCo60resUpCh2Filtered->Scale(ScaleCo60[channel], "noSW2");
    hsimCo60resUpCh2Filtered->Draw("same");
    cShow1->cd(14)->Modified();
    cShow1->cd(14)->Update();

    cShow1->cd(15);    
    hcalCo60UpCh3Filtered->SetLineColor(kRed);
    hcalCo60UpCh3Filtered->Draw();
    hsimCo60resUpCh3Filtered->Scale(ScaleCo60[channel], "noSW2");
    hsimCo60resUpCh3Filtered->Draw("same");
    cShow1->cd(15)->Modified();
    cShow1->cd(15)->Update();

    cShow1->cd(16);
    hcalCo60Filtered->Draw();
    hsimCo60resUpSig1Filtered->Scale(ScaleCo60[channel], "noSW2");
    hsimCo60resUpSig1Filtered->Draw("same");
    cShow1->cd(16)->Modified();
    cShow1->cd(16)->Update();

    cShow1->cd(17);
    hcalCo60Filtered->Draw();
    hsimCo60resUpSig2Filtered->Scale(ScaleCo60[channel], "noSW2");
    hsimCo60resUpSig2Filtered->Draw("same");
    cShow1->cd(17)->Modified();
    cShow1->cd(17)->Update();

    cShow1->cd(18);
    hcalCo60Filtered->Draw();
    hsimCo60resUpSig3Filtered->Scale(ScaleCo60[channel], "noSW2");
    hsimCo60resUpSig3Filtered->Draw("same");
    cShow1->cd(18)->Modified();
    cShow1->cd(18)->Update();
    ...
    if(deltaChi2 > thresh){
      ...
      delete hsimCs137resUpCh3;
      delete hcalCs137UpCh3;
      delete hsimCs137resUpSig1;
      delete hsimCs137resUpSig2;
      delete hsimCs137resUpSig3;
      ...
      delete hsimCs137resUpCh3Filtered;
      delete hcalCs137UpCh3Filtered;
      delete hsimCs137resUpSig1Filtered;
      delete hsimCs137resUpSig2Filtered;
      delete hsimCs137resUpSig3Filtered;
      ...
      delete hsimNa22resUpCh3;
      delete hcalNa22UpCh3;
      delete hsimNa22resUpSig1;
      delete hsimNa22resUpSig2;
      delete hsimNa22resUpSig3;
      ...
      delete hsimNa22resUpCh3Filtered;
      delete hcalNa22UpCh3Filtered;
      delete hsimNa22resUpSig1Filtered;
      delete hsimNa22resUpSig2Filtered;
      delete hsimNa22resUpSig3Filtered;

      delete hsimCo60res;
      delete hcalCo60;
      delete hsimCo60resUpCh1;
      delete hcalCo60UpCh1;
      delete hsimCo60resUpCh2;
      delete hcalCo60UpCh2;
      delete hsimCo60resUpCh3;
      delete hcalCo60UpCh3;
      delete hsimCo60resUpSig1;
      delete hsimCo60resUpSig2;
      delete hsimCo60resUpSig3;

      delete hsimCo60resFiltered;
      delete hcalCo60Filtered;
      delete hsimCo60resUpCh1Filtered;
      delete hcalCo60UpCh1Filtered;
      delete hsimCo60resUpCh2Filtered;
      delete hcalCo60UpCh2Filtered;
      delete hsimCo60resUpCh3Filtered;
      delete hcalCo60UpCh3Filtered;
      delete hsimCo60resUpSig1Filtered;
      delete hsimCo60resUpSig2Filtered;
      delete hsimCo60resUpSig3Filtered;
    }
    else{}
